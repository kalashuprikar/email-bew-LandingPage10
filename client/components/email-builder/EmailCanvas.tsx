...
export const EmailCanvas: React.FC<EmailCanvasProps> = ({
  ...
  return (
    <div ref={scrollContainerRef} className="flex-1 overflow-y-auto bg-gray-50 flex flex-col items-center">
      <div
        className="transition-transform duration-300 ease-in-out py-12 px-8 flex flex-col items-center min-h-full w-full"
        style={{
          transform: `scale(${zoom})`,
          transformOrigin: "top center",
          height: zoom < 1 ? "auto" : "fit-content",
        }}
      >
        <div className="w-full max-w-2xl bg-white border border-gray-200 rounded-lg shadow-sm">
          {/* Template Settings */}
          <div className="border-b border-gray-200 p-6 overflow-x-hidden">
            <div className="grid grid-cols-2 gap-4">
              <div className="min-w-0">
                <label
                  htmlFor="subject"
                  className="text-xs font-bold text-gray-700 block uppercase tracking-wider"
                >
                  Email Subject
                </label>
                <input
                  ...
                  className="text-sm mt-2 w-full border border-gray-300 rounded-md px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-valasys-orange focus:border-transparent bg-gray-50/50"
                />
              </div>
              <div className="min-w-0">
                <label
                ...
                <div className="flex gap-2 mt-2 min-w-0">
                  <div className="relative flex-shrink-0">
                    ...
                    />
                    <div
                      className="w-10 h-10 border border-gray-300 rounded-md shadow-inner"
                  ...
                  <input
                    ...
                    value={template.backgroundColor}
                    onChange={(e) => onBackgroundColorChange(e.target.value)}
                    className="text-sm border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-valasys-orange focus:border-transparent flex-1 bg-gray-50/50"
                    placeholder="#ffffff"
                  />
                </div>
              </div>
              <div className="min-w-0 col-span-2">
                ...
                <div className="flex gap-2 mt-2 min-w-0">
                  <div className="relative flex-shrink-0">
                    ...
                    <div
                      className="w-10 h-10 border border-gray-300 rounded-md shadow-inner"
                      style={{ backgroundColor: template.documentBackgroundColor || "#ffffff" }}
                    />
                  </div>
                  <input
                    type="text"
          ...
          <div
            ...
            className={cn(
              "transition-all p-8 relative",
              isOver && "ring-2 ring-valasys-orange ring-inset",
            )}
            onClick={(e) => {
